...
allGO2genes <- annFUN.org(whichOnto="MF", feasibleGenes=NULL, mapping="org.Hs.eg.db", ID="symbol")  # only select cellular component because this is what I want to confirm first
```
...
runtopGO <- function(genelist, annot, allgenes, selectfun){
  GOdata <- new("topGOdata", ontology="MF", allGenes=genelist, annot=annot, GO2genes=allgenes, geneSel=selectfun, nodeSize=10)
